...
/**
 * Contract types for construction trades:
 * - labor_only:    Subcontractor provides only labor; main contractor procures materials
 * - supply_and_fix: Subcontractor provides both labor and materials (most common)
 * - supply_install: Full supply, install & commission — turnkey (MEP equipment, elevators)
 */
...
const MECHANICAL_TRADES: SubTradeTemplate[] = [
  { name: 'Plumbing Rough-in', code: 'MEC-PLB', color: '#3B82F6', discipline: 'mechanical', defaultCrewSize: 4, durationMultiplier: 0.8, predecessorCodes: ['STR-FRC'], sortOrder: 1, defaultContractType: 'supply_and_fix' },
  { name: 'HVAC Ductwork', code: 'MEC-HVC', color: '#06B6D4', discipline: 'mechanical', defaultCrewSize: 5, durationMultiplier: 1.0, predecessorCodes: ['STR-FRC'], sortOrder: 2, defaultContractType: 'supply_and_fix' },
  ...
  { name: 'HVAC Testing & Balancing', code: 'MEC-TAB', color: '#0D9488', discipline: 'mechanical', defaultCrewSize: 3, durationMultiplier: 0.6, predecessorCodes: ['MEC-EQP'], sortOrder: 6, defaultContractType: 'supply_install' },
  { name: 'Plumbing Fixtures', code: 'MEC-FIX', color: '#2563EB', discipline: 'mechanical', defaultCrewSize: 3, durationMultiplier: 0.6, predecessorCodes: ['MEC-EQP'], sortOrder: 7, defaultContractType: 'supply_and_fix' },
];
...
const ELECTRICAL_TRADES: SubTradeTemplate[] = [
  { name: 'Electrical Rough-in (Conduit)', code: 'ELC-RGH', color: '#F59E0B', discipline: 'electrical', defaultCrewSize: 4, durationMultiplier: 0.8, predecessorCodes: ['STR-FRC'], sortOrder: 1, defaultContractType: 'supply_and_fix' },
  ...
  { name: 'Lighting Installation', code: 'ELC-LGT', color: '#FBBF24', discipline: 'electrical', defaultCrewSize: 4, durationMultiplier: 0.8, predecessorCodes: ['ELC-CBL'], sortOrder: 5, defaultContractType: 'supply_and_fix' },
  { name: 'Fire Alarm & Detection', code: 'ELC-FAD', color: '#DC2626', discipline: 'electrical', defaultCrewSize: 3, durationMultiplier: 0.6, predecessorCodes: ['ELC-CBL'], sortOrder: 6, defaultContractType: 'supply_install' },
  { name: 'Data & Communications', code: 'ELC-DAT', color: '#7C3AED', discipline: 'electrical', defaultCrewSize: 3, durationMultiplier: 0.6, predecessorCodes: ['ELC-CTR'], sortOrder: 7, defaultContractType: 'supply_install' },
  { name: 'Security & CCTV', code: 'ELC-SEC', color: '#6D28D9', discipline: 'electrical', defaultCrewSize: 3, durationMultiplier: 0.4, predecessorCodes: ['ELC-CBL'], sortOrder: 8, defaultContractType: 'supply_install' },
  { name: 'BMS Controls', code: 'ELC-BMS', color: '#4C1D95', discipline: 'electrical', defaultCrewSize: 2, durationMultiplier: 0.6, predecessorCodes: ['ELC-SWG', 'MEC-TAB'], sortOrder: 9, defaultContractType: 'supply_install' },
];
...
const ARCHITECTURAL_TRADES: SubTradeTemplate[] = [
  { name: 'Masonry / Blockwork', code: 'ARC-MSN', color: '#D97706', discipline: 'architectural', defaultCrewSize: 6, durationMultiplier: 1.0, predecessorCodes: ['STR-FRC'], sortOrder: 1, defaultContractType: 'labor_only' },
  ...
  { name: 'Facade / Curtain Wall', code: 'ARC-FAC', color: '#0EA5E9', discipline: 'architectural', defaultCrewSize: 6, durationMultiplier: 1.2, predecessorCodes: ['STR-FRC'], sortOrder: 4, defaultContractType: 'supply_install' },
  ...
  { name: 'Painting & Decoration', code: 'ARC-PNT', color: '#EC4899', discipline: 'architectural', defaultCrewSize: 5, durationMultiplier: 0.8, predecessorCodes: ['ARC-DRW', 'ARC-CLG'], sortOrder: 8, defaultContractType: 'labor_only' },
  { name: 'Doors & Hardware', code: 'ARC-DOR', color: '#78716C', discipline: 'architectural', defaultCrewSize: 3, durationMultiplier: 0.6, predecessorCodes: ['ARC-PNT'], sortOrder: 9, defaultContractType: 'supply_and_fix' },
  { name: 'Windows & Glazing', code: 'ARC-WND', color: '#38BDF8', discipline: 'architectural', defaultCrewSize: 4, durationMultiplier: 0.8, predecessorCodes: ['ARC-MSN'], sortOrder: 10, defaultContractType: 'supply_install' },
  { name: 'Cabinetry & Millwork', code: 'ARC-CAB', color: '#92400E', discipline: 'architectural', defaultCrewSize: 4, durationMultiplier: 0.8, predecessorCodes: ['ARC-PNT'], sortOrder: 11, defaultContractType: 'supply_install' },
  { name: 'FF&E (Furniture)', code: 'ARC-FFE', color: '#F97316', discipline: 'architectural', defaultCrewSize: 4, durationMultiplier: 0.6, predecessorCodes: ['ARC-FLR', 'ARC-PNT'], sortOrder: 12, defaultContractType: 'supply_install' },
];
...
const LANDSCAPE_TRADES: SubTradeTemplate[] = [
  ...
  { name: 'Irrigation Systems', code: 'LND-IRR', color: '#06B6D4', discipline: 'landscape', defaultCrewSize: 3, durationMultiplier: 0.6, predecessorCodes: ['LND-DRN'], sortOrder: 5, defaultContractType: 'supply_install' },
  { name: 'Soft Landscaping (Planting)', code: 'LND-PLT', color: '#16A34A', discipline: 'landscape', defaultCrewSize: 5, durationMultiplier: 1.0, predecessorCodes: ['LND-IRR'], sortOrder: 6, defaultContractType: 'supply_and_fix' },
  { name: 'Fencing & Barriers', code: 'LND-FNC', color: '#57534E', discipline: 'landscape', defaultCrewSize: 4, durationMultiplier: 0.6, predecessorCodes: ['LND-HRD'], sortOrder: 7, defaultContractType: 'supply_and_fix' },
  { name: 'External Furniture & Signage', code: 'LND-FRN', color: '#A16207', discipline: 'landscape', defaultCrewSize: 3, durationMultiplier: 0.4, predecessorCodes: ['LND-PLT'], sortOrder: 8, defaultContractType: 'supply_install' },
];
  ...
  },
  {
    ...
    disciplines: [
      ...
      { discipline: 'mechanical', included: true, extraTrades: [
        { name: 'Medical Gas Systems', code: 'MEC-MED', color: '#14B8A6', discipline: 'mechanical', defaultCrewSize: 3, durationMultiplier: 0.8, predecessorCodes: ['STR-FRC'], sortOrder: 8, defaultContractType: 'supply_install' },
      ...
      { discipline: 'electrical', included: true, extraTrades: [
        { name: 'UPS / Emergency Power', code: 'ELC-UPS', color: '#DC2626', discipline: 'electrical', defaultCrewSize: 3, durationMultiplier: 0.6, predecessorCodes: ['ELC-SWG'], sortOrder: 10, defaultContractType: 'supply_install' },
        { name: 'Nurse Call Systems', code: 'ELC-NCS', color: '#8B5CF6', discipline: 'electrical', defaultCrewSize: 2, durationMultiplier: 0.4, predecessorCodes: ['ELC-CBL'], sortOrder: 11, defaultContractType: 'supply_install' },
      ]},
      { discipline: 'architectural', included: true },
      { discipline: 'landscape', included: true },
    ],
  ...
  },
  {
    ...
    disciplines: [
      ...
      { discipline: 'architectural', included: true, extraTrades: [
        { name: 'Raised Access Floor', code: 'ARC-RAF', color: '#94A3B8', discipline: 'architectural', defaultCrewSize: 4, durationMultiplier: 0.8, predecessorCodes: ['MEC-PLB', 'ELC-RGH'], sortOrder: 13, defaultContractType: 'supply_and_fix' },
      ]},
      { discipline: 'landscape', included: true },
    ],
  },
